...
class Testmultiplicativecipher(unittest.TestCase):
    ...
    def test_mulencrypt(self):
        ...
        self.assertEqual(self.p3.mulencrypt("h",3),'Exception raised string length greter than 1 required')
    ...
    def test_trandecrypt(self):
        ...
        self.assertEqual(self.p3.muldecrypt("h",3),'Exception raised string length greter than 1 required')
    @classmethod
    def setUpClass(cls):
